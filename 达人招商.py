...
while True:
    for n in range(0,20):
        ...
        pyautogui.click(x=1173, y=348, button='left')
        sleep(1)
        ...
        sleep(0.5)
        pyautogui.moveTo(x=989,y=423,duration=0.3)
        pyautogui.click(x=989,y=423, button='left')
        ...
        pyautogui.keyDown('enter')
        pyautogui.moveTo(x=1273,y=980, duration=0.3)
        pyautogui.click(x=1273,y=980, button='left')
        pyautogui.moveTo(x=1583,y=179, duration=0.3)
        pyautogui.click(x=1583,y=179, button='left')
        pyautogui.moveTo(x=1583,y=179, duration=0.3)
        pyautogui.click(x=1583,y=179, button='left')
        ...
        pyautogui.click(x=1611,y=917, button='left')
        sleep(1)
        pyautogui.typewrite('scroll(100,1)')
        pyautogui.keyDown('enter')
        sleep(2)
        pyautogui.moveTo(x=1173, y=348, duration=0.3)
        pyautogui.click(x=1173, y=348, button='left')
