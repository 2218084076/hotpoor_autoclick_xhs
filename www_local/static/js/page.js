...
(function() {
  var Hs, WS_DEVICE, formatDate, formatDateAll, formatDateAllEn, hotpoor_timestamp, hotpoor_ws, hotpoor_ws_device, root,
  ...
  $(function() {
    var device_uuid, heartCheck, hotpoor_ws_device_open, hotpoor_ws_timer, restart_ws_connection;
    console.log("page");
    ...
    root.comment_add_one_base = function(content_json) {
      var content, date_html, html, user_headimgurl, user_name;
    ...
    root.comment_load_one_base = function(comment_list) {
      var content, date_html, html, user_headimgurl, user_name;
    ...
    return $("body").on("click", ".comment_submit", function(evt) {
      var chat_id, content, dom;
      dom = $(this);
