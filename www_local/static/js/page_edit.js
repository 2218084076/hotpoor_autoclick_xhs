...
(function() {
  ...
  $(function() {
    ...
    iframe_add_comments_area = function(dom_sequence, block_id) {
      clearTimeout(iframe_add_comments_area_timeout);
      return iframe_add_comments_area_timeout = setTimeout(function() {
        var iframe_comments_area;
        if ($("#" + dom_sequence).length < 1) {
        ...
        iframe_comments_area = "<div class=\"comments_area\" data-block=\"" + block_id + "\">\n    <div><textarea class=\"comment_content\" placeholder=\"Add some comment...\"></textarea><button class=\"comment_submit\">submit</button></div>\n    <div class=\"comments\"></div>\n</div>\n<script>\n$(window).on(\"load\",function(){\n    comment_load(\"" + block_id + "\")\n})\n</script>";
        $("#" + dom_sequence).find(".iframe_html").val(iframe_comments_area);
        return $("#" + dom_sequence).find(".iframe_save").click();
      }, 1000);
    };
    $("body").on("click", ".comment_entity_line_tools>.load_card", function(evt) {
      var _h, _hbase, _w, _wbase, ajax_data, comments_area_block, dom_type, dom_type_old, uri;
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          if (data.info === "ok") {
            if (dom_type_old === "comments_area") {
              return iframe_add_comments_area(data.dom_sequence, comments_area_block);
            }
          }
        },
        error: function(data) {
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          if (data.info === "ok") {
            ...
            } else if (dom_type_old === "comments_area") {
              return iframe_add_comments_area(data.dom_sequence);
            }
          }
        },
        error: function(data) {
