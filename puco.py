...
for id in json_files:
    ...
    os.system("adb -s 869e65410721 shell input tap 118 1078")
    time.sleep(2)
    os.system('adb -s 869e65410721 shell ime set com.android.adbkeyboard/.AdbIME')
    os.system(f'adb -s 869e65410721 shell am broadcast -a ADB_INPUT_TEXT --es msg  "puco返航计划"')
    time.sleep(1)
    os.system('adb -s 869e65410721 shell ime set com.iflytek.inputmethod.miui/.FlyIME')
    time.sleep(1)
    os.system("adb -s 869e65410721 shell input tap 308 521")
    time.sleep(1)
    os.system('adb -s 869e65410721 shell ime set com.android.adbkeyboard/.AdbIME')
    time.sleep(1)
