                ...
                $.ajax
                    ...
                    success:(data)->
                        ...
                        if data.info == "ok"
                            ...
                            check_content_in_chat base_json,"product-code-value",base_json["product-code-value"],page_entity_id,chat_id,null
                    error:(data)->
                        console.log data
        error:(data)->
            console.log data
...
$("body").on "click","#xialiwei_20220120_json_check_btn",(e)->
    ...
    check_content_in_action check_content_json,"detail-box-title",detail_box_title,"220ae362b930423f8707b5b1b5b276bd",null
